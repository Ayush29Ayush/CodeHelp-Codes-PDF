...
public:
    bool checkInclusion(string s1, string s2)
    {
        ...
        { // check if window moves ahead of length of 2nd string => that's why additional condition
            int index = s2[i] - 'a';
            count2[index]++;
            i++;
        }
        ...
        { // keep window processing ahead, shifting and checking & ++ the new char and -- the old char in window to maintain correct count
